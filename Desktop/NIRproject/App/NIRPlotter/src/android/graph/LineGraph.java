...
private GraphicalView view;
	...
	private TimeSeries dataset = new TimeSeries("Hb"); 
	private TimeSeries dataset2 = new TimeSeries("HbO2"); 
	...
	public LineGraph()
	{
		...
		mRenderer.setYTitle("[Hb]/[HbO](mMol)");
		mRenderer.setChartTitle("Real-time NIR Analysis");
		mRenderer.setAxesColor(Color.GREEN);
